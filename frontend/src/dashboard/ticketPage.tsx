...
const TicketDetail = ({ ticketId, onBack }) => {
  ...
  const auditLogs = [
    { id: 1, action: 'TICKET_CREATED', actor: 'user', timestamp: '2025-01-21T14:30:00Z', meta: { ticketId } },
    { id: 2, action: 'AGENT_CLASSIFIED', actor: 'system', timestamp: '2025-01-21T14:30:15Z', meta: { category: 'tech', confidence: 0.72 } },
    { id: 3, action: 'KB_RETRIEVED', actor: 'system', timestamp: '2025-01-21T14:30:18Z', meta: { articles: ['article-3'] } },
    { id: 4, action: 'DRAFT_GENERATED', actor: 'system', timestamp: '2025-01-21T14:30:22Z', meta: { confidence: 0.72 } },
    { id: 5, action: 'ASSIGNED_TO_HUMAN', actor: 'system', timestamp: '2025-01-21T14:30:25Z', meta: { reason: 'Low confidence' } }
  ];
